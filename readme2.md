...
(The following steps tested win10 system.)
...
### 1. Clone
Fork the repo in howdyai/botkit-cms to your account & clone it using command
...
### Data folder
 create a new .data folder to store scripts generated in UI. 
